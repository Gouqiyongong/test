(this, function(e, n) {
    function i(n, i, t) {
        ...
        (e.WeixinJSBridge && WeixinJSBridge) ? WeixinJSBridge.invoke(n, o(i), function(e) {
            c(n, e, t)
        }) : u(n, t)
    }

    function t(n, i, t) {
        (e.WeixinJSBridge && WeixinJSBridge) ? WeixinJSBridge.on(n, function(e) {
    ...
    function f(n) {
        k && ((e.WeixinJSBridge && WeixinJSBridge) ? "preInject" === I.__wxjsjs__isPreInject ? I.addEventListener && I.addEventListener("WeixinJSBridgeReady", n, !1) : n() : I.addEventListener && I.addEventListener("WeixinJSBridgeReady", n, !1))
    }

    function m() {
        N.invoke || (N.invoke = function(n, i, t) {
            (e.WeixinJSBridge && WeixinJSBridge) &&  WeixinJSBridge.invoke(n, o(i), t)
        }, N.on = function(n, i) {
            (e.WeixinJSBridge && WeixinJSBridge) && WeixinJSBridge.on(n, i)
        })
    }
